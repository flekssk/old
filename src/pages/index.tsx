  ...
  return (
    <div className="p-4 dark:bg-gray-900 max-w-screen-2xl mx-auto">
      ...
      <p className="mb-8 text-lg text-gray-500 dark:text-gray-400 max-w-3xl">
        Get started with 190 premium UI components based on Tailwind CSS, Flowbite, and React with support for TypeScript to upgrade your development stack and collaborate with designers to build websites even faster.
      </p>
